...
const links = [
  { name: "Home", href: "/" },
  { name: "Plataformas", href: "/software" },
  { name: "Capacitaciones", href: "/capacitaciones" },
  //{ name: "Implementaciones Tecnológicas", href}
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#0B0B0D]/80 backdrop-blur-xl border-b border-white/5">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-4 gap-4">
        ...
        {/* 🔥 MARCA COMPLEJA: EducaInnova + MACOR ATE */}
        <div className="flex items-center gap-4 shrink-0">
          <Link href="/" className="flex items-center">
            <div className="relative flex items-center justify-center">
              ...
              <Image
                ...
                width={140}
                height={40}
                className="relative w-auto h-[40px] object-contain bg-transparent hover:scale-105 transition"
              />
            </div>
          </Link>
          ...
          <div className="flex items-center justify-center shrink-0">
            <Image 
              ...
              width={140} 
              height={40} 
              className="w-auto h-[40px] object-contain rounded-sm" 
            />
          </div>
        </div>
